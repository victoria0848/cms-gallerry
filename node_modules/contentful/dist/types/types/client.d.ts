 ...
 * @internal
 */
export type ChainModifiers = 'WITH_ALL_LOCALES' | 'WITHOUT_LINK_RESOLUTION' | 'WITHOUT_UNRESOLVABLE_LINKS' | 'WITH_LOCALE_BASED_PUBLISHING' | undefined;
/**
...
export interface ContentfulClientApi<Modifiers extends ChainModifiers> {
    ...
    withLocaleBasedPublishing: 'WITH_LOCALE_BASED_PUBLISHING' extends Modifiers ? never : ContentfulClientApi<AddChainModifier<Modifiers, 'WITH_LOCALE_BASED_PUBLISHING'>>;
    /**
